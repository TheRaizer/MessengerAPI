...
from tests.routers.friends.get_friend_request_recievers.conftest import (
...
class TestGetFriendRequestRecievers:
    ...
    def test_produces_200_when_successful(
        ...
        response = test_client.get(
            f"/friends/requests/recievers?limit={limit}&{cursor}"
        )
    ...
    def test_produces_400_when_cursor_invalid(
        ...
        response = test_client.get(
            f"/friends/requests/recievers?limit=2&cursor={invalid_cursor}"
        )
    ...
    def test_retrieves_first_page(
        ...
        response = test_client.get(f"/friends/requests/recievers?limit={limit}")
    ...
    def test_retrieves_middle_page(
        ...
        response = test_client.get(
            f"/friends/requests/recievers?limit={limit}&cursor={cursor}"
        )
