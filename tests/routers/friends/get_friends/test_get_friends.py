...
from tests.routers.friends.get_friends.conftest import (
...
class TestGetFriends:
    ...
    def test_produces_200_when_successful(
        ...
        response = test_client.get(f"/friends?limit={limit}&{cursor}")
    ...
    def test_produces_400_when_cursor_invalid(
        ...
        response = test_client.get(f"/friends?limit=2&cursor={invalid_cursor}")
    ...
    def test_retrieves_first_page_of_accepted_friendships(
        ...
        response = test_client.get(f"/friends?limit={limit}")
    ...
    def test_retrieves_middle_page_of_accepted_friendships(
        ...
        response = test_client.get(f"/friends?limit={limit}&cursor={cursor}")
